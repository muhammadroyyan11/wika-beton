            ...
            <form action="forms/contact.php" method="post" role="form" class="php-email-form">
                ...
                <div class="row">
                    <div class="col form-group">
                        ...
                        <input type="datetime-local" class="form-control" name="email" id="email" placeholder="Your Email" required />
                    </div>
                    <div class="col form-group">
                ...
                <div class="row">
                    <div class="col form-group">
                        ...
                        <input type="text" class="form-control" name="text" id="text" placeholder="Koordinat Lokasi Proyek" required />
                    </div>
                    <div class="col form-group">
                    ...
                    <div class="col form-group">
                        ...
                        <input type="text" class="form-control" name="text" id="text" placeholder="Jarak Batching Plant Menuju Site" required />
                    </div>
                </div>
